...
func (l *LayoutTemplate) With(content ...interface{}) io.WriterTo {
	...
	if l.Viewport != "" {
		viewport = Meta(Name("viewport"), ContentAttr(l.Viewport))
	}
