...
// helpers, response helpers, cache-key helpers, deferred view values, typed HTTP
// errors, redirects, content negotiation, SEO convenience methods, and
// Server-Sent Events entrypoints.
//
