...
func (c *Base) AddFlash(key string, value any) {
...
func (c *Base) AddNoticeFlash(msg any) {
	c.AddFlash(FlashNotice, msg)
}
func (c *Base) AddWarningFlash(msg any) {
	c.AddFlash(FlashWarning, msg)
}
func (c *Base) AddSuccessFlash(msg any) {
	c.AddFlash(FlashSuccess, msg)
}
func (c *Base) AddErrorFlash(msg any) {
	c.AddFlash(FlashError, msg)
}

func (c *Base) Flashes(key ...string) []FlashMessager {
...
func (c *Base) FlashesByType() map[string][]any {
	m := map[string][]any{}
